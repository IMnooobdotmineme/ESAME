        ...
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="flex items-center justify-between h-[72px]">
            ...
            <div className="hidden lg:flex items-center gap-3">
              <Link
                href="/student/join"
                className="flex items-center gap-2 pl-5 pr-2 py-2 bg-white border border-white/0 rounded-full text-sm text-[#1f385c] font-semibold transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg"
              >
                Student Key
              ...
              <Link
                href="/sign-up"
                className="group relative px-6 py-2.5 rounded-full text-sm font-semibold text-[#0f1c31] bg-[#4fc3f7] overflow-hidden transition-all duration-300 hover:shadow-[0_0_25px_-4px_rgba(79,195,247,0.7)] hover:-translate-y-0.5"
              >
        ...
        >
          <nav className="flex flex-col px-6 py-4 gap-1">
            ...
            <Link
              href="/student/join"
              onClick={() => setMobileOpen(false)}
              className="flex items-center justify-between gap-2 pl-5 pr-2 py-2 mt-3 bg-white rounded-full text-sm text-[#1f385c] font-semibold"
            >
              Student Key
              <span className="w-7 h-7 bg-[#1f385c] text-white rounded-full flex items-center justify-center shrink-0">
                <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3" />
                </svg>
              </span>
