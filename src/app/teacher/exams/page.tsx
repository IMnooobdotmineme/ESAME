...
export default function MyExamsPage() {
  ...
  // Map store structure to match your UI fields cleanly
    ...
    <div className="max-w-6xl mx-auto space-y-6 font-sans text-gray-900">
      ...
      <div className="bg-white p-6 rounded-2xl border border-gray-200 flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-sm">
        ...
        <button
          ...
          className="bg-[#0B7A93] hover:bg-[#086277] text-white font-semibold px-5 py-2.5 rounded-xl flex items-center justify-center gap-2 transition-all shadow-sm"
        >
      ...
      <div className="space-y-4">
        {exams.length === 0 ? (
          <div className="bg-white p-12 rounded-2xl border border-gray-200 text-center space-y-3">
            <p className="text-sm font-bold text-gray-400">No exams available.</p>
            <button
              onClick={() => router.push("/teacher/exams/new")}
              className="text-xs text-[#0B7A93] font-bold underline"
            >
            ...
            >
              ...
              <div className="flex items-center gap-3 shrink-0">
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 border border-gray-200 rounded-xl text-xs font-bold text-gray-700 hover:bg-gray-50 transition-colors"
                >
