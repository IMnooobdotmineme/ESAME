...
const NAV_ITEMS = [
  ...
  { label: "Live Monitoring", href: "/teacher/monitor", icon: Radio },
  { label: "Grading & Results", href: "/teacher/grading", icon: FileCheck },
  ...
  return (
    <aside className="hidden lg:flex lg:flex-col w-64 shrink-0 h-screen sticky top-0 bg-navy-900 text-white">
      ...
      <div className="px-6 pt-5 pb-2">
        <p className="text-xs uppercase tracking-wide text-white/40">Teacher</p>
