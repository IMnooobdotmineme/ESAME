...
interface ExamStore {
  exams: Exam[];
  requestToJoin: (roomCode: string, studentName: string) => { success: boolean; message?: string; requestId?: string };
  getStudentStatus: (roomCode: string, requestId: string) => "pending" | "approved" | "rejected" | null;
